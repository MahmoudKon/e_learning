...
if (isset($_SESSION["user"])) {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $course   = $_POST["course"];
    if ($_FILES) {
      $av_name     = explode(" ", microtime())[1] . '.' . explode('/', $_FILES['video-src']['type'])[1];
...
-->
  ...
  <div class="container">
    <!-- Start Container Bootstrap Class [ Container ] -->
    <!--
=====================================================================================================================================
...
=====================================================================================================================================
 -->
    <section class="form mb-5">
      <!-- Start Section Class [ Information ] -->
      <div class="card">
        <!-- Start Card Bootstrap Class [ Card ] -->

        <div class="card-header bg-primary" style="color: #fff;">
          <!-- Start Card-header Bootstrap Class [ Header ] -->
          <i class='fa fa-info-circle fa-fw'></i> Add New Video
        </div> <!-- End Card-header Bootstrap Class [ Header ] -->

        <div class="card-body">
          <!-- Start Card-Body Bootstrap Class [ Body ] -->
          <div class="row">
            <!-- Start Div Bootstrap Class [ Row ] -->
            <!--
=====================================================================================================================================
...
-->
            <div class="col-8">
              <!-- Start Div Bootstrap Class [ Col-8  Left Section ] -->
              <form class="form-horizontal text-center" action="?action=Insert" method="POST" enctype="multipart/form-data">
                <!-- End Form -->
...
-->
            ...
            <div class="col-4">
              <!-- Start Div Bootstrap Class [ Col-4  Right Section ] -->
              ...
              <div class="card">
                ...
                <div class="card-block live-preview">
                  <!--  Start card-block DIV  -->
